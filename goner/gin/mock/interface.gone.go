...
import (
	...
	gin0 "github.com/gone-io/gone/goner/gin"
...
func (m *MockController) Mount() gin0.MountError {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Mount")
	ret0, _ := ret[0].(gin0.MountError)
	return ret0
}
...
func (m *MockHandleProxyToGin) Proxy(handler ...gin0.HandlerFunc) []gin.HandlerFunc {
	m.ctrl.T.Helper()
	varargs := []any{}
...
func (m *MockHandleProxyToGin) ProxyForMiddleware(handlers ...gin0.HandlerFunc) []gin.HandlerFunc {
	m.ctrl.T.Helper()
	varargs := []any{}
...
func (m *MockResponser) Failed(ctx gin0.XContext, err error) {
	m.ctrl.T.Helper()
...
func (m *MockResponser) ProcessResults(context gin0.XContext, writer gin.ResponseWriter, last bool, funcName string, results ...any) {
	m.ctrl.T.Helper()
...
func (m *MockResponser) Success(ctx gin0.XContext, data any) {
	m.ctrl.T.Helper()
...
func (m *MockHttInjector) BindFuncs() gin0.BindStructFunc {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BindFuncs")
	ret0, _ := ret[0].(gin0.BindStructFunc)
	return ret0
}
