...
//
//	mockgen -source=../interafce.go -destination=./mock.go -package=mock
//
...
func (m *MockFuncInjector) InjectFuncParameters(fn any, injectBefore, injectAfter v2.FuncInjectHook) ([]reflect.Value, error) {
	m.ctrl.T.Helper()
...
func (m *MockFuncInjector) InjectWrapFunc(fn any, injectBefore, injectAfter v2.FuncInjectHook) (func() []any, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoader) Load(goner v2.Goner, options ...v2.Option) error {
	m.ctrl.T.Helper()
	varargs := []any{goner}
...
func (m *MockLoader) Loaded(arg0 v2.LoaderKey) bool {
	m.ctrl.T.Helper()
